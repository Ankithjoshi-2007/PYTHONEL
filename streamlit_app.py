...
# Dynamically import airfoil_simulation (1).py
airfoil_sim = importlib.import_module("airfoil_simulation (1)")
AirfoilAero = airfoil_sim.AirfoilAero
naca_profile = airfoil_sim.naca_profile
rotate_airfoil = airfoil_sim.rotate_airfoil
compute_flow_field = airfoil_sim.compute_flow_field
evaluate_velocity_at = airfoil_sim.evaluate_velocity_at
parse_airfoil_file = airfoil_sim.parse_airfoil_file
analyze_geometry = airfoil_sim.analyze_geometry
_init_particles = airfoil_sim._init_particles
_is_inside_airfoil = airfoil_sim._is_inside_airfoil
_step_particles = airfoil_sim._step_particles

# Import from flight_analyzer
from flight_analyzer import Aircraft, Aerodynamics, FlightAnalyzer
